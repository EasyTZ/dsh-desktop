...
- **报 bug / 提需求**：[提交 Issue](https://github.com/EasyTZ/Deepseek-Harness-Desktop/issues)，客户端托盘菜单里也有「反馈问题」可以直接跳转。
- **QQ 群**：群号 `263261649`，扫下面二维码入群。

  <img src="docs/qq-group.jpg" alt="QQ 交流群二维码" width="240">
